...
public enum Sinif {
    ...
    SAVASCI(
            ...
            List.of(
                    ...
                    "<red>✦ <gray>Saldırı gücü <white>%20 <gray>daha yüksek",
                    "<red>✦ <gray>Vuruşlarda daha az savrulur",
    ...
    SUIKASTCI(
            ...
            List.of(
                    ...
                    "<dark_purple>✦ <gray>Saldırı hızı <white>%15 <gray>daha yüksek",
                    "<dark_purple>✦ <gray>Kılıçla <white>%25<gray>, arkadan <white>%60 <gray>ekstra hasar",
                    "<dark_purple>✦ <gray>Kırılgan: <white>-1 kalp<gray>, <white>%10 <gray>fazla hasar alır"
            )
    ),
    ...
    RAHIP(
            ...
            List.of(
                    "<yellow>✦ <gray>Kalıcı <white>+1 kalp <gray>ve <white>+1 zırh",
    ...
    OKCU(
            ...
            List.of(
                    ...
                    "<green>✦ <gray>Hareket hızı <white>%12 <gray>daha yüksek",
                    "<green>✦ <gray>Daha uzaktan etkileşim menzili",
    ...
    BUYUCU(
            ...
            List.of(
                    ...
                    "<aqua>✦ <gray>Uzatılmış büyü erişim menzili",
    ...
    AVCI(
            ...
            List.of(
                    "<gold>✦ <gray>Mızrakla <white>%30 <gray>ekstra hasar",
                    "<gold>✦ <gray>Üç dişli mızrakla <white>%25 <gray>ekstra hasar",
                    "<gold>✦ <gray>Fırlatılan üç dişli <white>%30 <gray>daha sert vurur",
